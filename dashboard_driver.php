...
$driver_bus = $_SESSION['bus_number'];
$driver_name = $_SESSION['name'];
$first_letter = strtoupper(substr($driver_name, 0, 1));

// --- Database Queries (Using original logic for simplicity) ---

// Get mentor details for the same bus
$mentors_result = $conn->query("SELECT name, email FROM users WHERE role='mentor' AND bus_number='$driver_bus'");

// Get student details for the same bus
$students_result = $conn->query("SELECT name, email, register_number FROM users WHERE role='student' AND bus_number='$driver_bus'");

// Count totals
$total_mentors = $conn->query("SELECT COUNT(*) as total FROM users WHERE role='mentor' AND bus_number='$driver_bus'")->fetch_assoc()['total'];
$total_students = $conn->query("SELECT COUNT(*) as total FROM users WHERE role='student' AND bus_number='$driver_bus'")->fetch_assoc()['total'];

$total_passengers = $total_mentors + $total_students;
...
$displayName = truncateName($driver_name);
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stat-card:nth-child(4) { /* Highlight Total Passengers */
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            <div class="logo">
                ...
                <div class="logo-text">BusTrack Driver</div>
            </div>
            <ul class="nav-links">
                <li><a href="#" class="active"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
                <li><a href="#mentors-list"><i class="fas fa-users"></i> <span>Mentor Contacts</span></a></li>
                <li><a href="#students-list"><i class="fas fa-user-graduate"></i> <span>Student List</span></a></li>
                <li><a href="#"><i class="fas fa-route"></i> <span>Route Map</span></a></li>
        ...
        <div class="main-content" id="mainContent">
            ...
            <h2 class="section-title">Bus & Passenger Overview</h2>
            <div class="stats-container">
                <div class="stat-card">
                    <h3>Assigned Bus</h3>
                    <div class="number"><?php echo htmlspecialchars($driver_bus); ?></div>
                </div>
                <div class="stat-card">
                    <h3>Total Mentors</h3>
                    <div class="number"><?php echo $total_mentors; ?></div>
                </div>
                <div class="stat-card">
            ...
            <h2 class="section-title" id="mentors-list">Mentors on Bus <?php echo htmlspecialchars($driver_bus); ?></h2>
            <div class="card">
                ...
                <?php else: ?>
                    <p>No mentors assigned to this bus. Contact your supervisor for assistance.</p>
                <?php endif; ?>
            </div>

            <h2 class="section-title" id="students-list">Students on Bus <?php echo htmlspecialchars($driver_bus); ?></h2>
            <div class="card">
